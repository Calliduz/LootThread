...
import { Loader2, Github, Eye, EyeOff, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-bg-dark flex items-center justify-center p-6 relative">
      ...
      <div className="max-w-md w-full bg-bg-card border border-white/10 rounded-2xl p-8 relative z-10 shadow-2xl space-y-8 mt-12">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button type="button" className="flex items-center justify-center gap-2 bg-white flex-1 text-black font-bold uppercase text-xs py-3 rounded-xl hover:bg-gray-200 transition-colors">
          ...
          <button type="button" className="flex items-center justify-center gap-2 bg-[#24292e] text-white font-bold uppercase text-xs py-3 rounded-xl hover:bg-[#1b1f23] transition-colors">
